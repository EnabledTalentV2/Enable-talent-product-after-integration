      ...
      <div className="rounded-[28px] bg-[#FCD34D] p-6">
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end">
            ...
            <span className="text-xs font-medium text-slate-800">Matching</span>
          </div>
        </div>
        <button className="mt-6 w-full rounded-xl bg-[#C27803] py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#a36502]">
