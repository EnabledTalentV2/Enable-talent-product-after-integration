      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)]">
        <div className="space-y-6">
          <div className="flex items-start justify-between rounded-[28px] bg-[#F7D16C] px-6 py-5 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-slate-700">{profileRole}</p>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="rounded-[28px] bg-white p-6 shadow-sm">
            ...
            {isAboutExpanded ? (
              <div id="about-section" className="mt-4 space-y-4 text-sm leading-relaxed text-slate-600">
              ...
              return (
                <div key={section.id} className="rounded-[28px] bg-white shadow-sm">
                  <div className="flex items-center justify-between px-5 py-4">
                    <div>
                      ...
                      {typeof section.count === "number" ? (
                        <p className="text-xs text-slate-400">{section.count} added</p>
                      ) : null}
                    </div>
                    <button
                      type="button"
                  ...
                  {isExpanded ? (
                    <div
                      id={contentId}
                      className="border-t border-slate-100 px-5 pb-4 pt-3 text-sm text-slate-600"
                    >
