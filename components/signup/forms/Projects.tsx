...
export default function Projects({ data, errors, onEntryChange, onAddEntry, onRemoveEntry }: Props) {
        ...
        return (
          <div key={idx} className="space-y-6 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <InputBlock
              ...
              onChange={(v) => onEntryChange(idx, { projectDescription: v })}
              ...
              <div className="flex items-center gap-8">
                <label className="flex items-center gap-2 text-base text-slate-700 cursor-pointer">
                  <input
                    ...
                    checked={isCurrent}
                    onChange={() => onEntryChange(idx, { current: true, to: "" })}
