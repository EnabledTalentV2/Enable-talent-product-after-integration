      ...
      <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative flex items-center justify-center bg-white/90 backdrop-blur rounded-full w-28 h-28 shadow-md border-4 border-white/20">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center leading-none">
            ...
            <span className="text-sm uppercase font-semibold text-slate-500">Profile</span>
            <span className="text-sm uppercase font-semibold text-slate-500">Completed</span>
          </div>
        </div>
      </div>
    </header>
